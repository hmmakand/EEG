"""Command-line entry point for broadcast-11 weighted-GCN LOSO training."""
...
from src.ourexperimentversionthree.training.config import TrainingConfig
from src.ourexperimentversionthree.training.loso import (
