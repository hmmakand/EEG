...
``src.ourexperimentversionfive.data.loso_split.create_inner_cv_folds``) over
...
from src.ourexperimentversionfive.data import EXPECTED_NODES, EXPECTED_NODE_FEATURES
from src.ourexperimentversionfive.data.combinations import Combination
from src.ourexperimentversionfive.data.loso_split import GraphDataLoaderConfig, InnerCvFold, create_inner_cv_folds
...
def _score_candidate(
    ...
    *,
    ...
    loader_config = GraphDataLoaderConfig(
        node_normalization=candidate_config.node_normalization,
...
def select_hyperparameters(
    ...
    *,
    ...
    if any("node_normalization" in candidate for candidate in resolved_grid):
        raise ValueError("node_normalization is fixed per run; compare modes in separate runs")
